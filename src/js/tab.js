...
vAPI.tabs.onPopupUpdated = (function() {
    ...
    return function(targetTabId, openerDetails) {
        ...
        // https://github.com/gorhill/uBlock/issues/3133
        //   But that assumption has trade-offs, so it can be bypassed
        if ( µBlock.hiddenSettings.mustWaitForPopupURLchange === false ||
